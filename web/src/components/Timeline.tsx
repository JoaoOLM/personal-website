...
const phases: Phase[] = [
  { id: 1, title: "Disciplinas & Fundamentação", description: "Conclusão dos créditos e base teórica.", status: "completed" },
  { id: 2, title: "Qualificação", description: "Defesa do projeto e alinhamento com a banca.", status: "completed" },
  { id: 3, title: "Experimentos", description: "Coleta e análise de dados no laboratório.", status: "in-progress" },
  { id: 4, title: "Dissertação & Defesa", description: "Escrita final e defesa do mestrado na UFSCar.", status: "pending" },
];
    ...
    <div className="w-full max-w-4xl mx-auto py-12 relative">
      <h2 className="text-2xl font-bold mb-10 text-foreground">
        <span className="relative inline-block">
          Linha do Tempo: Mestrado UFSCar
